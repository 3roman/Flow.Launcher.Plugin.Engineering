...
namespace Wox.Plugin.SteamTable
{
    public class SteamTable : IPlugin, IPluginI18n
    {
        ...
        private List<Result> P_L(double press)
        {
            ...
            try
            {
                Wrapper.P2T97(press, ref t, ref r);

                Wrapper.P2HL97(press, ref hL, ref r);
                Wrapper.P2SL97(press, ref sL, ref r);
                Wrapper.P2VL97(press, ref vL, ref r);
                Wrapper.P2ETAL97(press, ref etaL, ref r);
                Wrapper.P2KSL97(press, ref kL, ref r);
        ...
        private List<Result> P_V(double press)
        {
            ...
            try
            {
                ...
                Wrapper.P2HG97(press, ref hG, ref r);
                Wrapper.P2SG97(press, ref sG, ref r);
                Wrapper.P2VG97(press, ref vG, ref r);
                Wrapper.P2ETAG97(press, ref etaG, ref r);
                Wrapper.P2KSG97(press, ref kG, ref r);
            }
            catch (Exception e)
            {
                MessageBox.Show(e.Message);
